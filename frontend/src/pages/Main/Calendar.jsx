    ...
    <div>
      ...
      <div className="w-full min-h-screen bg-gray-50 flex flex-row">
        ...
        <div className="w-20 bg-white border-r border-gray-200 flex flex-col items-center gap-4 py-6">
          ...
          <button onClick={(e)=>navigate("/calendar")} className=" w-12 h-12 bg-sky-100 text-sky-600 rounded-xl flex items-center justify-center hover:bg-blue-200 transition-colors">
